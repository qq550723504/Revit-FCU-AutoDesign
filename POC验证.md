...
现固定为“距门侧墙内侧 500 mm、沿墙方向居中”：门及门墙定义基准墙和朝向，墙厚半值加 500 mm 得到 FCU 中心落点，沿墙方向取房间边界中点，并通过 `Room.IsPointInRoom` 校验。已移除几何中心选项，不再使用门点到设备点的 800 mm 假设。目标点超出房间时不伪造坐标，仍报告定位失败。
